...
from retrieve_code.phone_code import retrieve_phone_code
...
class UrbanRoutesPage:
    ...
    def get_sms_code(self):
        return self.driver.find_element(*self.sms_code).send_keys(code)

    def get_confirmar_button(self):
        return self.wait.until(EC.element_to_be_clickable(self.confirmar_button))
